...
public class ItemDefsEditor extends JDialog {
	...
	public void save() {
		...
		//inv
		defs.setModelId(Integer.valueOf(modelIDField.getText()));
		defs.setName(nameField.getText());
		defs.setSpriteScale(Integer.valueOf(modelZoomField.getText()));
		String[] groundOptions = groundOptionsField.getText().split(";");
		for(int i = 0; i < defs.getGroundActions().length; i++)
			defs.getGroundActions()[i] = groundOptions[i].equals("null") ? null : groundOptions[i];
		String[] invOptions = inventoryOptionsField.getText().split(";");
		for(int i = 0; i < defs.getItemActions().length; i++)
			defs.getItemActions()[i] = invOptions[i].equals("null") ? null : invOptions[i];
		
		//wearing
		
		defs.primaryMaleModel = Integer.valueOf(maleModelId1Field.getText());
		defs.secondaryMaleModel = Integer.valueOf(maleModelId2Field.getText());
		defs.tertiaryMaleEquipmentModel = Integer.valueOf(maleModelId3Field.getText());
		
		defs.primaryFemaleModel = Integer.valueOf(femaleModelId1Field.getText());
		defs.secondaryFemaleModel = Integer.valueOf(femaleModelId2Field.getText());
		defs.tertiaryFemaleEquipmentModel = Integer.valueOf(femaleModelId3Field.getText());
		defs.team = Integer.valueOf(teamIdField.getText());
		
		//others
		defs.certTemplateID = Integer.valueOf(notedItemIdField.getText());
		defs.certID = Integer.valueOf(switchNotedItemField.getText());
		...
		defs.membersObject = membersOnlyCheck.isSelected();
	...
	public ItemDefsEditor(Application application, ItemDefinitions defs) {
		...
		contentPanel.add(lblNewLabel);
		{
			...
			modelIDField.setText(""+defs.getModelId());
		}
		{
		...
		}
		{
			...
			modelZoomField.setText(""+defs.getSpriteScale());
		}
		{
		...
		femaleModelId2Field.setText(""+defs.secondaryFemaleModel);
		...
		maleModelId1Field.setText(""+defs.primaryMaleModel);
		{
			...
			maleModelId2Field.setText(""+defs.secondaryMaleModel);
		}
		{
			...
			maleModelId3Field.setText(""+defs.tertiaryMaleEquipmentModel);
		}
		{
			...
			femaleModelId1Field.setText(""+defs.primaryFemaleModel);
		}
		{
			...
			femaleModelId3Field.setText(""+defs.tertiaryFemaleEquipmentModel);
		}
		{
		...
		}
		{
			...
			notedItemIdField.setText(""+defs.certTemplateID);
		}
		{
			...
			switchNotedItemField.setText(""+defs.certID);
		}
		{
			...
			lendedItemIdField.setText(""+defs.unnotedId);
		}
		{
			...
			switchLendedItemField.setText(""+defs.notedId);
		}
		{
		...
		membersOnlyCheck.setSelected(defs.membersObject);
